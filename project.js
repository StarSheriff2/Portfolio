...
var Project = function Project() {
  ...
  return React.createElement(
    "section",
    { "class": "project-section p-4 container-md", "data-aos": "fade-right", "data-aos-duration": "1000" },
    React.createElement(
      "div",
      { "class": "row" },
      React.createElement(
        "div",
        { "class": "col-md me-md-3 d-md-grid align-content-center" },
        React.createElement(
          "div",
          { "class": "screenshot-div-frame screenshot-div-frame-7-bg-color mb-3 mb-md-0" },
          React.createElement("div", { "class": "project-screenshot-div-container project-screenshot-7-background" })
        )
      ),
      React.createElement(
        "div",
        { "class": "project-info-wrapper col-md d-md-flex flex-column align-items-start mt-md-2" },
        React.createElement("a", { href: "#", "class": "project-md-stretched-link d-none d-md-block stretched-link", "data-bs-toggle": "modal",
          "data-bs-target": "#project7" }),
        React.createElement(
          "h3",
          null,
          "Expert Class React Component"
        ),
        React.createElement(
          "ul",
          { "class": "d-flex flex-wrap mb-md-4" },
          React.createElement(
            "li",
            null,
            React.createElement(
              "span",
              { "class": "caption caption-bold" },
              "Web App"
            )
          ),
          React.createElement(
            "li",
            { "class": "neutral-bullet-point mx-2" },
            "\u2022"
          ),
          React.createElement(
            "li",
    ...
    React.createElement(
      "div",
      { "class": "modal fade", id: "project7", tabindex: "-1", "aria-labelledby": "project6", "aria-hidden": "true" },
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { "class": "modal-header pb-md-0" },
            React.createElement(
              "h3",
              { "class": "modal-title", id: "expert-class" },
              "Expert Class"
            ),
            React.createElement("button", { type: "button", "class": "btn-close me-2", "data-bs-dismiss": "modal", "aria-label": "Close" })
          ),
          React.createElement(
            "ul",
            { "class": "d-flex flex-wrap px-3 mb-md-2" },
            React.createElement(
              "li",
              null,
              React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { "class": "screenshot-div-frame screenshot-div-frame-7-bg-color" },
              React.createElement("div", { "class": "project-screenshot-div-container project-screenshot-7-background" })
            )
          ),
          React.createElement(
            "div",
            { "class": "modal-footer pt-0 pb-3" },
            React.createElement(
              "div",
              { "class": "container-fluid-md w-100" },
              React.createElement(
                "div",
                { "class": "row" },
                React.createElement(
                  "div",
                  { "class": "modal-footer-project-description col-md-8" },
                  React.createElement(
                    "p",
                    { "class": "project-section-para mt-0" },
                ...
                React.createElement(
                  ...
                  React.createElement("hr", { "class": "mt-3 mb-4 w-100" }),
                  React.createElement(
                    "div",
                    { "class": "modal-footer-buttons-wrapper w-100 d-flex mt-4" },
                    React.createElement(
                      "button",
                      { type: "button", "class": "w-100 modal-button my-0 me-1 py-md-2",
                        onclick: "window.open('https://expert-class-frontend-v2.netlify.app')", value: "See live" },
                      "See live ",
                      React.createElement("i", { "class": "ps-2 fas fa-external-link-alt" })
                    ),
                    React.createElement(
                      "button",
                      { type: "button", "class": "w-100 modal-button my-0 ms-1 py-md-2",
                        onclick: "window.open('https://github.com/StarSheriff2/expert-class')", value: "See Source" },
                      "See Source ",
                      React.createElement("i", { "class": "ps-2 fab fa-github" })
                    )
                  )
                )
              )
